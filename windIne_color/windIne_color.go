...
const (
	// ANSIColorForegroundBlack Foreground Colors 前景色
	...
	// ANSIColorForegroundBrightBlack Bright Foreground Colors 亮色前景色
	...
	// ANSIColorBackgroundBlack Background Colors 背景色
	...
	// ANSIColorBackgroundBrightBlack Bright Background Colors 亮色背景色
	...
	// ANSIColorReset Reset Color 重置颜色
